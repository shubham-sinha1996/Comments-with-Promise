...
exports.getMessages = exports.getComments = void 0;
const messages = [{
  id: 1,
  user: "James Doe",
  ...
  message: "Strolling through Central Park is an amazing feeling. Not only does it put you right in the middle of an amazing display of flora and fauna but its the people who are the greatest asset. The smiles on their face, the peace on their mind is worth a million dollars."
}, {
  id: 3,
  user: "Buzz Lightyear",
  message: "Well, how is everyone today? I've just returned to Planet Earth and boy everything has changed!"
}];
const comments = [{
  id: 1,
  forId: 1,
  ...
  forId: 1,
  user: "Rohit Consul",
  message: "I had a terrific experience there recently. The crew is hands-on and they really understand tastes well."
}, {
  id: 3,
  forId: 2,
  user: "Rohit Consul",
...
const createMessage = ({
  ...
  <div class="comments">
    ${getComments && getComments.length > 0 ? getComments.map(e => createComment(e.user, e.message)).join("") : "No Comments"}
  </div>
</div>`;
  return baseTemplate;
};
const renderContent = (messages, comments, container) => {
...
getMessageBtn.addEventListener("click", () => {
  ...
  error.innerText = "";
  Promise.allSettled([(0, _api.getMessages)(), (0, _api.getComments)()])
  // .then((res) =>
  ...
  .then(([{
    ...
    value: comments
  }]) => (0, _utils.renderContent)(messages, comments, messagesContainer))
  //.catch((error) => (errorEl.innerText = `${error}`))
  .finally(() => spinner.style.display = "none");
});
},{"../api":"api/index.js","../utils":"utils/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
